  ...
  <span class="slider btn btn-success rounded"></span>
    ...
    <div class="form-group ml-2 mr-2">
      ...
      <div class="form-control-plaintext">.</div>
              ...
              <div class="form-group flex-grow-1">
                <label for=""
                  >Host<sup class="text-danger" title="required">*</sup>
                  <small>(domain, with optionnal subdomain or wildcard)</small
                  >&nbsp;
              ...
              <div class="form-group">
                ...
                <button
                  ...
                  :class="{
                    'btn-primary': isValidPrimaryPattern || !isAnExistingRule,
                    'btn-outline-primary':
                      !isValidPrimaryPattern || isAnExistingRule,
                  }"
                >
                  {{ actionText }}
                </button>
...
<div class="btn-group btn-group-sm" role="group" aria-label="First group">
    ...
    <button type="button" class="btn btn-outline-secondary">setting</button>
              ...
              <div class="mb-3">
                ...
                <small
                  v-if="!isValidPrimaryPattern"
                  class="form-text text-muted"
                  >To add a rule, enter a <b>host</b>, like
                  <code>github.com</code>, <code>gist.github.com</code>, or
